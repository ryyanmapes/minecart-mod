...
public class MoreMinecartsMod
{
    ...
    private static final RegistryObject<EntityType<HSStasisMinecart>> HS_STASIS_CART_ENTITY = ENTITIES.register("high_speed_stasis_minecart", () -> EntityType.Builder.<HSStasisMinecart>of(HSStasisMinecart::new, EntityClassification.MISC ).sized(0.98F, 0.7F).build("high_speed_stasis_minecart"));
    private static final RegistryObject<EntityType<HSFlagMinecart>> HS_FLAG_CART_ENTITY = ENTITIES.register("high_speed_flag_minecart", () -> EntityType.Builder.<HSFlagMinecart>of(HSFlagMinecart::new, EntityClassification.MISC ).sized(0.98F, 0.7F).build("high_speed_flag_minecart"));
    ...
    private static final RegistryObject<Block> HOLOGRAM_RAIL = BLOCKS.register("hologram_rail", () -> new HolographicRail(of(Material.DECORATION).noCollission().harvestTool(ToolType.PICKAXE).strength(0.2F).sound(SoundType.GLASS)));
    private static final RegistryObject<Block> WOODEN_RAIL_BLOCK = BLOCKS.register("wooden_rail", () -> new WoodenRail(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.7F).sound(SoundType.BAMBOO)));
    private static final RegistryObject<Block> WOODEN_RAIL_TURN = BLOCKS.register("wooden_rail_turn", () -> new WoodenRailTurn(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.7F).sound(SoundType.BAMBOO)));
    private static final RegistryObject<Block> WOODEN_PARALLEL_RAIL_BLOCK = BLOCKS.register("wooden_parallel_rail", () -> new WoodenParallelRail(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.7F).sound(SoundType.BAMBOO)));
    private static final RegistryObject<Block> WOODEN_CROSS_RAIL_BLOCK = BLOCKS.register("wooden_cross_rail", () -> new WoodenRailCrossing(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.7F).sound(SoundType.BAMBOO)));
    private static final RegistryObject<Block> WOODEN_PROJECTOR_RAIL = BLOCKS.register("wooden_projector_rail", () -> new WoodenProjectorRail(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.7F).sound(SoundType.BAMBOO)));
    private static final RegistryObject<Block> WOODEN_HOLOGRAM_RAIL = BLOCKS.register("wooden_hologram_rail", () -> new WoodenHolographicRail(of(Material.BAMBOO_SAPLING).noCollission().harvestTool(ToolType.AXE).strength(0.2F).sound(SoundType.GLASS)));
    ...
    private static final RegistryObject<Block> MAGLEV_HOLOGRAM_RAIL = BLOCKS.register("maglev_hologram_rail", () -> new MaglevHolographicRail(of(Material.DECORATION, MaterialColor.COLOR_BLUE).noCollission().harvestTool(ToolType.PICKAXE).strength(0.2F).sound(SoundType.GLASS)));
    ...
    private static final RegistryObject<Block> BIOLUMINESCENT_RAIL_BLOCK = BLOCKS.register("bioluminescent_rail", () -> new WoodenRail(of(Material.DECORATION).noCollission().strength(0.7F).sound(SoundType.BAMBOO).lightLevel((state)->10)));
    ...
    private static final RegistryObject<Block> ORGANIC_GLASS = BLOCKS.register("organic_glass", () -> new GlassBlock(of(Material.BUILDABLE_GLASS).sound(SoundType.GLASS).noOcclusion().isValidSpawn((a,b,c,d)->false).isRedstoneConductor((a,b,c)->false).isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)));
    private static final RegistryObject<Block> ORGANIC_GLASS_PANE = BLOCKS.register("organic_glass_pane", () -> new PaneBlock(of(Material.BUILDABLE_GLASS).sound(SoundType.GLASS).noOcclusion().isValidSpawn((a,b,c,d)->false).isRedstoneConductor((a,b,c)->false).isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)));
    private static final RegistryObject<Block> CHISELED_ORGANIC_GLASS = BLOCKS.register("chiseled_organic_glass", () -> new GlassBlock(of(Material.BUILDABLE_GLASS).sound(SoundType.GLASS).noOcclusion().isValidSpawn((a,b,c,d)->false).isRedstoneConductor((a,b,c)->false).isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)));
    private static final RegistryObject<Block> CHISELED_ORGANIC_GLASS_PANE = BLOCKS.register("chiseled_organic_glass_pane", () -> new PaneBlock(of(Material.BUILDABLE_GLASS).sound(SoundType.GLASS).noOcclusion().isValidSpawn((a,b,c,d)->false).isRedstoneConductor((a,b,c)->false).isSuffocating((a,b,c)->false).isViewBlocking((a,b,c)->false)));
    private static final RegistryObject<Block> GLASS_CACTUS = BLOCKS.register("glass_cactus", () -> new GlassCactusBlock(of(Material.CACTUS).randomTicks().strength(2F).sound(SoundType.WOOL).noOcclusion()));
    ...
    private static final RegistryObject<Item> TRANSPORT_TANK = ITEMS.register("transport_tank", () -> new Item(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MATERIALS)));
    private static final RegistryObject<Item> TRANSPORT_BATTERY = ITEMS.register("transport_battery", () -> new Item(new Item.Properties().stacksTo(1).tab(ItemGroup.TAB_MATERIALS)));
    ...
    public MoreMinecartsMod() {
        ...
        if (EndergeticCompat.endergeticInstalled()) {
            ...
            HS_ENDFIRE_CART_ENTITY = ENTITIES.register("high_speed_endfire_minecart", () -> EntityType.Builder.<HSEndfireMinecart>of(HSEndfireMinecart::new, EntityClassification.MISC ).sized(0.98F, 0.7F).build("high_speed_endfire_minecart"));
        }
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(high_speed_stasis_minecart, HSMinecartRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(high_speed_flag_minecart, HSMinecartRenderer::new);
